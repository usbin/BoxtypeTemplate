...
import kotlinx.android.synthetic.main.fragment_risk_tab_speed.*
 ...
 */
class SpeedTabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_risk_tab_speed, container, false)
    }

    override fun onResume() {
        super.onResume()
        Log.d("riskActivity", "onResume: speed fragment")
    }
    companion object {
        /**
