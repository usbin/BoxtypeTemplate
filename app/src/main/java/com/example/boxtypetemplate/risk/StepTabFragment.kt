...
import kotlinx.android.synthetic.main.fragment_risk_tab_step.*
 ...
 */
class StepTabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_risk_tab_step, container, false)
    }

    override fun onResume() {
        super.onResume()
        Log.d("riskActivity", "onResume: step fragment")
    }
